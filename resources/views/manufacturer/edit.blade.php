...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <form method="post" action="{{ route('updateManufacturer', $entity->id) }}" accept-charset="UTF-8">
                        @csrf
                        @method('patch')
                        <div class="card-header">{{ __('Gyártó módosítása') }} (#{{$entity->id}})</div>
                        <div class="card-body">
                            @if (session('status'))
                        ...
                        <div class="card-footer row text-center" style="margin-left: 0; margin-right: 0">
                            ...
                            <div class="col-auto">
                                <a class="btn" href="{{ route('manufacturers') }}#{{$entity->id}}"><i class="fa fa-ban"></i>&nbsp;{{__('Mégse')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
